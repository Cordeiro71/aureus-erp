        ...
        'actions' => [
            ...
            'delete' => [
                'notification' => [
                    ...
                    'default-company' => [
                        'title' => 'Empresa cannot be excluído',
                        'body'  => 'Este empresa is set as the empresa padrão in Manage Usuários configurações. Please change the empresa padrão antes deleting.',
                    ],
                ],
            ],
            ...
            'force-delete' => [
                'notification' => [
                    'success' => [
                        'title' => 'Empresa excluído definitivamente',
                        'body'  => 'A Empresa foi excluído definitivamente com sucesso.',
                    ],
                    'error' => [
                        'title' => 'Unable para excluir definitivamente empresa',
                        'body'  => 'Este empresa is associated com existing records e cannot be deleted.',
                    ],
                ],
            ],
        ],
        ...
        'bulk-actions' => [
            ...
            'force-delete' => [
                'notification' => [
                    ...
                    'error' => [
                        'title' => 'Unable para excluir definitivamente empresas',
                        'body'  => 'One ou more empresas are associated com existing records e cannot be deleted.',
                    ],
                ],
            ],
        ],
